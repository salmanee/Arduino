...
import cc.arduino1.UpdatableBoardsLibsFakeURLsHandler;
import cc.arduino.UploaderUtils;
import cc.arduino.contributions.*;
import cc.arduino.contributions.libraries.*;
import cc.arduino1.contributions.ContributionsSelfCheck;
import cc.arduino1.contributions.libraries.LibraryOfSameTypeComparator;
import cc.arduino1.contributions.libraries.ui.LibraryManagerUI;
import cc.arduino.contributions.packages.ContributedPlatform;
import cc.arduino.contributions.packages.ContributionInstaller;
import cc.arduino.contributions.packages.ContributionsIndexer;
import cc.arduino1.contributions.packages.ui.ContributionManagerUI;
import cc.arduino.files.DeleteFilesOnShutdown;
import cc.arduino.packages.DiscoveryManager;
import cc.arduino1.view.Event;
import cc.arduino1.view.JMenuUtils;
import cc.arduino1.view.SplashScreenHelper;

import cc.arduino1.view.preferences.Preferences;
...
import processing.app1.helpers.ConsoleLogger;
import processing.app1.helpers.GUIUserNotifier;
import processing.app1.helpers.LogFormatter;
import processing.app1.javax.swing.filechooser.FileNameExtensionFilter;
import processing.app.legacy.PApplet;
import processing.app1.macosx.ThinkDifferent;
import processing.app.packages.LibraryList;
import processing.app.packages.UserLibrary;
import processing.app.packages.UserLibraryFolder.Location;
import processing.app1.syntax.PdeKeywords;
import processing.app1.syntax.SketchTextAreaDefaultInputMap;
...
public class Base {
  ...
  private cc.arduino1.contributions.ContributionsSelfCheck contributionsSelfCheck;
...
//  static Image icon;
  ...
  public Base(String[] args) throws Exception {
    ...
    if (parser.isInstallBoard()) {
      ...
      new Thread(new cc.arduino1.contributions.BuiltInCoreIsNewerCheck(this)).start();
...
//      }
  ...
  public void handlePrefs() {
    Preferences dialog = new Preferences(activeEditor, this);
    if (activeEditor != null) {
