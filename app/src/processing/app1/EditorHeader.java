...
import processing.app1.helpers.SimpleAction;
...
public class EditorHeader extends JComponent {
  ...
  static final int PIECE_HEIGHT = Theme.scale(33);
  ...
  public void paintComponent(Graphics screen) {
    ...
    int x = Theme.scale(6); // offset from left edge of the component
    int i = 0;
  ...
  public Dimension getMinimumSize() {
    Dimension size = Theme.scale(new Dimension(300, GRID_SIZE));
    if (OSUtils.isMacOS())
      size.height--;
    return size;
  }
  ...
  public Dimension getMaximumSize() {
    Dimension size = Theme.scale(new Dimension(30000, GRID_SIZE));
    if (OSUtils.isMacOS())
      size.height--;
    return size;
  }
