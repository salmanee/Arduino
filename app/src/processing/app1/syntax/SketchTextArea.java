...
package processing.app1.syntax;
...
public class SketchTextArea extends RSyntaxTextArea {
  ...
  private void setTheme(String name) throws IOException {
    ...
    try {
      defaultXmlInputStream = processing.app1.Theme.getThemeResource("theme/syntax/" + name + ".xml").getInputStream();
    ...
    setEOLMarkersVisible(processing.app1.Theme.getBoolean("editor.eolmarkers"));
    setBackground(processing.app1.Theme.getColor("editor.bgcolor"));
    setHighlightCurrentLine(processing.app1.Theme.getBoolean("editor.linehighlight"));
    setCurrentLineHighlightColor(processing.app1.Theme.getColor("editor.linehighlight.color"));
    setCaretColor(processing.app1.Theme.getColor("editor.caret.color"));
    setSelectedTextColor(null);
    setUseSelectedTextColor(false);
    setSelectionColor(processing.app1.Theme.getColor("editor.selection.color"));
    setMatchedBracketBorderColor(processing.app1.Theme.getColor("editor.brackethighlight.color"));
    setHyperlinkForeground((Color) processing.app1.Theme.getStyledFont("url", getFont()).get("color"));
  ...
  private void setColorForToken(int tokenType, String colorKeyFromTheme) {
    ...
    style.foreground = processing.app1.Theme.getColor(colorKeyFromTheme);
  ...
  private void setSyntaxTheme(int tokenType, String id) {
    ...
    Map<String, Object> styledFont = processing.app1.Theme.getStyledFont(id, style.font);
