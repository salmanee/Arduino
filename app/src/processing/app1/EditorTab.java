...
import processing.app1.syntax.ArduinoTokenMakerFactory;
import processing.app1.syntax.PdeKeywords;
import processing.app1.syntax.SketchTextArea;
import processing.app1.syntax.SketchTextAreaEditorKit;
import processing.app1.tools.DiscourseFormat;
...
public class EditorTab extends JPanel implements SketchFile.TextStorage, MouseWheelListener {
  ...
  private void configurePopupMenu(final SketchTextArea textarea){
    ...
    JMenuItem item = editor.createToolMenuItem("cc.arduino1.packages.formatter.AStyle");
    if (item == null) {
  ...
  public void applyPreferences() {
    ...
    Font editorFont = Theme.scale(PreferencesData.getFont("editor.font"));
