...
package cc.arduino1.contributions.libraries.ui;
...
import cc.arduino1.contributions.ui.DropdownItem;
import cc.arduino1.contributions.ui.FilteredAbstractTableModel;
import cc.arduino1.contributions.ui.InstallerJDialog;
import cc.arduino1.contributions.ui.InstallerJDialogUncaughtExceptionHandler;
import cc.arduino1.contributions.ui.InstallerTableCell;
...
public class LibraryManagerUI extends InstallerJDialog<ContributedLibraryReleases> {
  ...
  protected FilteredAbstractTableModel createContribModel() {
    return new cc.arduino1.contributions.libraries.ui.LibrariesIndexTableModel();
  }
  ...
  protected void onUpdatePressed() {
    ...
    installerThread = new Thread(() -> {
      try {
        ...
        ((cc.arduino1.contributions.libraries.ui.LibrariesIndexTableModel) contribModel).update();
        onIndexesUpdated();
      } catch (Exception e) {
