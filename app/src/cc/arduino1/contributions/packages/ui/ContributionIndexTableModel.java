...
import cc.arduino1.contributions.ui.FilteredAbstractTableModel;
...
public class ContributionIndexTableModel
  ...
  private final List<cc.arduino1.contributions.packages.ui.ContributedPlatformReleases> contributions = new ArrayList<>();
  ...
  private void addContribution(ContributedPlatform platform) {
    for (cc.arduino1.contributions.packages.ui.ContributedPlatformReleases contribution : contributions) {
    ...
    contributions.add(new cc.arduino1.contributions.packages.ui.ContributedPlatformReleases(platform));
  }
  ...
  public Object getValueAt(int row, int col) {
    ...
    cc.arduino1.contributions.packages.ui.ContributedPlatformReleases contribution = contributions.get(row);
