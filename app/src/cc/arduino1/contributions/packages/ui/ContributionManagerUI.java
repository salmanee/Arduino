...
package cc.arduino1.contributions.packages.ui;

import cc.arduino.contributions.DownloadableContribution;
import cc.arduino.contributions.packages.ContributedPlatform;
import cc.arduino.contributions.packages.ContributionInstaller;
import cc.arduino.utils.Progress;
import cc.arduino1.contributions.ui.InstallerJDialogUncaughtExceptionHandler;
...
public class ContributionManagerUI extends cc.arduino1.contributions.ui.InstallerJDialog {

  private final ContributionInstaller installer;

  @Override
  protected cc.arduino1.contributions.ui.FilteredAbstractTableModel createContribModel() {
    return new cc.arduino1.contributions.packages.ui.ContributionIndexTableModel();
  }

  private cc.arduino1.contributions.packages.ui.ContributionIndexTableModel getContribModel() {
  ...
  @Override
  protected cc.arduino1.contributions.ui.InstallerTableCell createCellEditor() {
  ...
  public void updateUI() {
    cc.arduino1.contributions.ui.DropdownItem<DownloadableContribution> previouslySelectedCategory = (cc.arduino1.contributions.ui.DropdownItem<DownloadableContribution>) categoryChooser
        .getSelectedItem();
  ...
  public void onUpdatePressed() {
    ...
    installerThread
        .setUncaughtExceptionHandler(new cc.arduino1.contributions.ui.InstallerJDialogUncaughtExceptionHandler(
