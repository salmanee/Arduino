...
package cc.arduino1.contributions.ui;
...
import cc.arduino1.contributions.ui.listeners.AbstractKeyListener;
...
public abstract class InstallerJDialog<T> extends JDialog {
  ...
  // - Search text-field
  protected final cc.arduino1.contributions.ui.FilterJTextField filterField;
  ...
  protected final cc.arduino1.contributions.ui.FilteredAbstractTableModel<T> contribModel;
  ...
  abstract protected cc.arduino1.contributions.ui.InstallerTableCell createCellEditor();
  ...
  public InstallerJDialog(Frame parent, String title, ModalityType applicationModal, String noConnectionErrorMessage) {
    ...
    contribTable.addMouseMotionListener(new MouseMotionListener() {
        ...
        public void mouseMoved(MouseEvent e) {
            ...
            if (!cc.arduino1.contributions.ui.InstallerTableCell.isDropdownSelected() && rowAtPoint != previousRowAtPoint) {
              contribTable.editCellAt(rowAtPoint, 0);
              previousRowAtPoint = rowAtPoint;
              cc.arduino1.contributions.ui.InstallerTableCell.dropdownSelected(false);
            }
            if (cc.arduino1.contributions.ui.InstallerTableCell.isDropdownSelected() && rowAtPoint == previousRowAtPoint) {
  ...
  public void setProgressVisible(boolean visible, String status) {
    ...
    if (contribTable.getCellEditor() != null) {
      ((cc.arduino1.contributions.ui.InstallerTableCell) contribTable.getCellEditor()).setEnabled(!visible);
